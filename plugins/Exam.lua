...
api.editMessageText(msg.chat.id, msg_id, text, keyboard, true)
 ...
 api.sendMessage(msg.from.id, text, true)
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a2_' then
    local co = examc.b
    local vb95 = msg.from.id..':new:2:res'
   db:set(vb95,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end5()
    local text = [[پاسخ ثبت شد]]
    local xb3 = msg.from.id..':new:2'
    local xb4 = 'true'
    db:set(xb3,xb4)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end7()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a3_' then
    local co = examc.c
    local vb96 = msg.from.id..':new:3:res'
   db:set(vb96,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end8()
    local text = [[پاسخ ثبت شد]]
    local xb5 = msg.from.id..':new:3'
    local xb6 = 'true'
    db:set(xb5,xb6)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end10()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a4_' then
    local co = examc.d
    local vb97 = msg.from.id..':new:4:res'
   db:set(vb97,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end11()
    local text = [[پاسخ ثبت شد]]
    local xb7 = msg.from.id..':new:4'
    local xb8 = 'true'
    db:set(xb7,xb8)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end13()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a5_' then
    local co = examc.e
    local vb98 = msg.from.id..':new:5:res'
   db:set(vb98,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end14()
    local text = [[پاسخ ثبت شد]]
    local xb9 = msg.from.id..':new:5'
    local xb10 = 'true'
    db:set(xb9,xb10)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end16()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a6_' then
    local co = examc.f
    local vb99 = msg.from.id..':new:6:res'
   db:set(vb99,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end17()
    local xb11 = msg.from.id..':new:6'
    local xb12 = 'true'
    db:set(xb11,xb12)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end19()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a7_' then
    local co = examc.g
    local vb100 = msg.from.id..':new:7:res'
   db:set(vb100,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end20()
    local xb13 = msg.from.id..':new:7'
    local xb14 = 'true'
    db:set(xb13,xb14)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end22()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a8_' then
    local co = examc.h
    local vb101 = msg.from.id..':new:8:res'
   db:set(vb101,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end23()
    local text = [[پاسخ ثبت شد]]
    local xb15 = msg.from.id..':new:8'
    local xb16 = 'true'
    db:set(xb15,xb16)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end25()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a9_' then
    local co = examc.i
    local vb102 = msg.from.id..':new:9:res'
   db:set(vb102,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end26()
    local text = [[پاسخ ثبت شد]]
    local xb17 = msg.from.id..':new:9'
    local xb18 = 'true'
    db:set(xb17,xb18)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
 ...
 local keyboard = do_keyboard_end28()
  ...
  api.editMessageText(chat, msg_id, text, keyboard, true)
   ...
   if query == 'a10_' then
    local co = examc.j
    local vb103 = msg.from.id..':new:10:res'
   db:set(vb103,query2)
    if query2 == co and etime then
    local keyboard = do_keyboard_end29()
    local text = [[پاسخ ثبت شد]]
    local xb19 = msg.from.id..':new:10'
    local xb20 = 'true'
    db:set(xb19,xb20)
    api.editMessageText(chat, msg_id, text, keyboard, true)
    end
